...
$nvoStep = Join-Path $nvoRoot 'source\combat\step4i'
...
$nvoRelease = Join-Path $nvoRoot 'release\NVO-Combat-Packet-4I-Native-Copy-Capture'
if ($nvoGame -ne 'C:\Users\regan\Desktop\Steam Install Folder\steamapps\common\Fallout New Vegas') { throw 'Unexpected game root.' }
if ($nvoPlan.packet -ne '4I' -or $nvoPlan.native_version -ne 328) { throw 'Unexpected packet.' }
...
$nvoExpected = @{
    'Data/NVSE/Plugins/NVOCombatCore.dll'='845300b703e60b53f36c8084f6b19253ac6dd272923b39eb5cb24657e6824556'
    'Data/NVSE/Plugins/NVOCombatCore.pdb'='1ecee825ef67c7e0219c54cc50658dddb60de33e97fa59d94bea397d4e1aa59d'
}
...
$nvoBackup = Child $nvoRoot ('backups\combat-install-4I-' + (Get-Date -Format 'yyyyMMdd-HHmmss') + '-' + [guid]::NewGuid().ToString('N').Substring(0,8))
