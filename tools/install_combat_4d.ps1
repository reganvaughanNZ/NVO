...
$nvoStep = Join-Path $nvoRoot 'source\combat\step4d'
...
$nvoRelease = Join-Path $nvoRoot 'release\NVO-Combat-Packet-4D-Armour-Identity'
if ($nvoGame -ne 'C:\Users\regan\Desktop\Steam Install Folder\steamapps\common\Fallout New Vegas') { throw 'Unexpected game root.' }
if ($nvoPlan.packet -ne '4D' -or $nvoPlan.native_version -ne 327) { throw 'Unexpected packet.' }
...
$nvoExpected = @{
    'Data/NVSE/Plugins/NVOCombatCore.dll'='3f0f68fa2a060ab7ffb6f832013d28388b0871b8a2b3c9f758fddeb826049c5b'
    'Data/NVSE/Plugins/NVOCombatCore.pdb'='afc7e8caee6c777d2d925a2adf56f6fe02e413ed9ac87f996cb638140fc1d281'
    'Data/NVSE/Plugins/NVOArmourCoverage.tsv'='0e25e3aafbd0aadf52fb58fb38b19cb079280d96006b0ee84f927fdd860973aa'
}
...
$nvoBackup = Child $nvoRoot ('backups\combat-install-4D-' + (Get-Date -Format 'yyyyMMdd-HHmmss') + '-' + [guid]::NewGuid().ToString('N').Substring(0,8))
