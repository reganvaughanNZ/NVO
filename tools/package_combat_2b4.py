"""Package the compiled 2B4 checkpoint. Does not install or execute game code."""
...
build = project / "out/build-26602-31189"
release = root / "release"
name = "NVO-Combat-Packet-2B4"
compiled = release / (name + "-Compiled")

def digest(path):
    return hashlib.sha256(path.read_bytes()).hexdigest()

expected = {"NVOCombatCore.dll": "cea7097b58bbcfc11d4cf32465ac2add91837a70b2506545b8e77af84bcc1fb4", "NVOCombatCore.pdb": "d7609d238203584a18496be441938488563ea6e7cccf4d0fa0ca6386678686e6"}
...
source = [project / n for n in (
    ...
    "THIRD-PARTY-NOTICES.md", "LICENSE-GPL-3.0.txt", "LICENSE-ITR-MIT.txt",
)]
source += sorted((project / "include").glob("*.hpp"))
source += sorted((project / "src").glob("*.cpp"))
source += [project / "src/Exports.def"]
manifest = {
    "packet": "NVO combat 2B4", "version": "0.2.3", "plugin_version": 203,
    "prepared": "2026-09-15", "status": "Compiled/static inspection complete; awaiting user current-hit capture",
    ...
    "native_event_handlers": 8, "event_limit_per_capture": 600,
    ...
    "additional_dependencies_added": ["Existing installed ITR 2.2.2 / 20202 now supplies damage-input diagnostics"],
    "itr_hit_limit_per_capture": 200, "itr_health_limit_per_capture": 200,
    "itr_dependency_sha256": "31f5abad415750141906efbe810a32eb35ac714335e65e806215655c72c7fc0c",
    ...
    "limits": "Copy input, ITR hit input and ITR prehealth streams are distinct and cannot be summed. No final HP-loss/application proof, projectile flight, injury or serialization implementation.",
}
...
for filename in ("build.log", "toolchain.log", "dll-details.txt", "wrapper-disassembly.txt", "damage-events-disassembly.txt", "static-evidence.json"):
