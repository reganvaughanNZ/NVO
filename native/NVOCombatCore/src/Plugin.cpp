...
void __cdecl OnNvseMessage(nvo::nvse::Message* message) noexcept
{
    ...
    case MessageType::PostLoadGame: {
        ...
        if (success) {
            ...
            nvo::armour::QueueCapture(gSession);
            nvo::avobserve::QueueCapture(gSession);
        } else {
            nvo::armour::Suspend("load_failed");
    ...
    case MessageType::ExitToMainMenu:
        nvo::armour::Suspend("exit_to_main_menu");
...
#else
    nvo::log::Write("CAPACITY_PROBE_BUILD enabled=0 production_capacity=128");
#endif
