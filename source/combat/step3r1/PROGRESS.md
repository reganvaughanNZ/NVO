...
3. Projectile flight: limited explicit kinetic profiles, per-shot private projectiles, G1/G7 drag and gravity integration, VATS/terrain/lifetime fixes and reload evidence.3P verified player creation/return identity.3Q dual-capacity admission and ordinary flight/reload checkpoint accepted; last shot was still airborne at exit. 3R controlled full-pool refusal and cleanup passed. 3R1 removes the temporary probe from the installed build; no repeated firing test requested. Units, impact-energy authority, stress/failure coverage and broader equipment coverage still need work.
